# 07 Set, Map & Dictionary
> Study Lead: 남수연(컴퓨터과학전공 19)
### 1. 과제 안내
- Link: https://www.acmicpc.net/group/practice/9273/9
- 필수문제: A, B, C, D
- 도전문제: E, F
- 필수문제를 모두 푸셔야 해당 주차의 출석이 인정되며, 도전문제는 출석에 영향을 주지 않습니다. (출석 -> 스코어보드 꼭 참고!!)

### 2. 출석 인정 조건
- DSC Sookmyung 그룹 내의 해당 주차 연습 **스코어보드를 기준**으로 필수문제가 모두 풀려있어야 함
